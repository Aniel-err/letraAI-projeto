...
const Notificacao = notificacaoModel(sequelize, Sequelize.DataTypes);
...
User.belongsToMany(Turma, {
  through: UserTurmas,
  as: "Turmas",
  foreignKey: "userId",
});
Turma.belongsToMany(User, {
  through: UserTurmas,
  as: "Users",
  foreignKey: "turmaId",
});
...
Redacao.hasMany(Notificacao, { foreignKey: "redacaoId" });
Notificacao.belongsTo(Redacao, { foreignKey: "redacaoId" });
